...
const ALL_ROLES = [SUPER_ADMIN, SCHOOL_ADMIN, PRINCIPAL, VICE_PRINCIPAL, TEACHER, STUDENT, SUBJECT_COORDINATOR];
const ADMIN_ROLES = [SUPER_ADMIN, SCHOOL_ADMIN];
<<<<<<< HEAD
const TEACHER_ROLES = [SUPER_ADMIN, SCHOOL_ADMIN, TEACHER, ACCOUNTANT, SUBJECT_COORDINATOR, "Principal", "Vice Principal", "Exam Coordinator"];
=======
const TEACHER_ROLES = [SUPER_ADMIN, SCHOOL_ADMIN, PRINCIPAL, VICE_PRINCIPAL, TEACHER, ACCOUNTANT, SUBJECT_COORDINATOR];
