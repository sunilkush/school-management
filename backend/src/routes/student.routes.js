...
const TEACHER_ROLE = ["Super Admin", "School Admin", "Principal", "Vice Principal", "Teacher", "Accountant", "Librarian", "Exam Coordinator", "Sports Teacher", "Class Teacher"];
...
router.get(
  "/roll-numbers",
  auth,
  roleMiddleware(["Super Admin", "School Admin", "Principal", "Vice Principal", "Teacher", "Class Teacher", "Medical Officer", "Sports Teacher"]),
  getClassRollNumbers
);
