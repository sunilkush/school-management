...
const historySchema = new Schema({
  action: { type: String, enum: ["created", "approved", "rejected", "emi_deducted", "closed"], required: true },
...
const loanAdvanceSchema = new Schema({
  ...
  status: { type: String, enum: ["pending", "active", "rejected", "closed"], default: "pending", index: true },
