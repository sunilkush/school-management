  ...
  return (
    <>
      <AccentListCard
        ...
        actions={
          <>
            <Button size="small" mode="text" compact onPress={() => setManagingSubscription(true)}>
              Subscription
            </Button>
            <IconButton
      ...
      />
      {managingSubscription && <ManageSubscriptionSheet school={school} onDismiss={() => setManagingSubscription(false)} />}
    </>
  );
}
