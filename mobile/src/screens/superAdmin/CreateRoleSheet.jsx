...
function PermissionRow({ row, onChange, onRemove }) {
  ...
  return (
    <View style={{ backgroundColor: colors.surfaceSoft, borderRadius: radii.md, padding: spacing.sm, marginBottom: spacing.sm }}>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: spacing.xs, paddingBottom: spacing.xs, alignItems: 'center' }}>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: spacing.xs, paddingTop: spacing.xs, alignItems: 'center' }}>
