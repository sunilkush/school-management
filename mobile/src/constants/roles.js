...
export const MODULE_META = {
  ...
  Circulars: { label: 'Circulars', icon: 'bullhorn-variant-outline' },
...
export const NAV_CONFIG = {
  ...
  [ROLE_NAMES.SCHOOL_ADMIN]: {
    ...
    items: [
      ...
      { group: 'Communication', icon: 'message-text-outline', items: ['Communication', 'Notifications', 'Circulars'] },
  ...
  [ROLE_NAMES.RECEPTIONIST]: {
    ...
    items: [
      ...
      'MyTasks', 'Payroll', 'GpsCheckInOut', 'MyAttendance', 'Leave', 'RoleWorkspace',
      { group: 'Communication', icon: 'message-text-outline', items: ['Broadcasts', 'Notifications', 'Circulars'] },
      'Profile',
    ],
  },
