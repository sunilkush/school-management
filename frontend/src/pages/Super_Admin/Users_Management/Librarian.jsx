...
const Librarian = () => {
  ...
  const librarians = useMemo(() => {
    let data = users.filter((u) => u?.role?.name === "Librarian");
    if (selectedSchool !== "All") {
      data = data.filter((l) => l.school?.name === selectedSchool);
    }
    return data;
    ...
    <div style={{ padding: 16 }}>
      ...
      <Card bordered={false} style={{ marginBottom: 16 }}>
        <Flex justify="space-between" align="center" wrap="wrap">
          <div>
            ...
            <Text type="secondary">
              Super Admin can manage librarians across all schools
            </Text>
          </div>
      ...
      <Card bordered={false}>
        <DataTable
          ...
          striped
          responsive
          noDataComponent="No librarians found"
          customStyles={{
            headCells: {
              style: {
                fontWeight: 600,
