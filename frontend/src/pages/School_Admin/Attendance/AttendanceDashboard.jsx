...
const AttendanceDashboard = () => {
  ...
  const QUICK_ACTIONS = [
    ...
    { icon: <UserOutlined />,    label: "Mark Staff",     color: "#d97706",        path: "/dashboard/schooladmin/attendance/staff"    },
    { icon: <CalendarOutlined />,label: "Leave Requests", color: "#7c3aed",        path: "/dashboard/schooladmin/attendance/leave"    },
    { icon: <FileTextOutlined />,label: "Reports",        color: "#16a34a",        path: "/dashboard/schooladmin/attendance/reports"  },
    { icon: <BarChartOutlined />,label: "Analytics",      color: "#f97316",        path: "/dashboard/schooladmin/attendance/analytics"},
  ];
        ...
        return (
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <Progress
              percent={pct}
              size="small"
              strokeColor={pct < 60 ? "#dc2626" : "#d97706"}
              trailColor="var(--border-muted)"
              showInfo={false}
        ...
        >
          ...
          {lowAttendanceStudents.length > 0 ? (
            ...
            <div style={{ padding: "24px 0", textAlign: "center" }}>
              <CheckCircleOutlined
                style={{ fontSize: 32, color: "#16a34a", marginBottom: 8 }}
              />
              <div
