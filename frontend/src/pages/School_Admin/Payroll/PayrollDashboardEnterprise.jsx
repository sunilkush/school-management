...
export default function PayrollDashboardEnterprise() {
  ...
  return (
    <Row gutter={16}>
      <Col span={8}>
        <Card>
          <Statistic title="Total Payout" value={dashboard?.totalPayout || 0} />
        </Card>
      </Col>
      <Col span={8}>
        <Card>
          <Statistic
            ...
            value={dashboard?.employeesProcessed || 0}
          />
        </Card>
      </Col>
      <Col span={8}>
        <Card>
          <Statistic title="Payroll Runs" value={dashboard?.totalRuns || 0} />
        </Card>
      </Col>
    </Row>
  );
