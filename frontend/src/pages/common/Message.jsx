                ...
                <List.Item style={{ padding: 0, marginBottom: 14 }}>
                  <Card
                    ...
                    style={{
                      borderRadius: 18,
                      cursor: "pointer",
                      border: isUnreadInbox ? "1px solid #b7eb8f" : "1px solid #eef2f7",
                      borderLeft: isUnreadInbox ? "5px solid #52c41a" : "1px solid #eef2f7",
                      background: isUnreadInbox ? "linear-gradient(135deg, #f6ffed 0%, #ffffff 72%)" : "#ffffff",
                    }}
                    ...
                    <Card style={{ borderRadius: 18, border: "1px solid #eef2f7" }} styles={{ body: { padding: 16 } }}>
                      <Space direction="vertical" size={10} style={{ width: "100%" }}>
                        <Flex vertical={isMobile} gap={8} justify="space-between" align={isMobile ? "flex-start" : "center"}>
                          <Space wrap>
                            <MessageSquareText size={16} color="#1677ff" />
