...
const CAT_COLORS = {
  "Staff Salary": "#7c3aed", "Teacher Salary": "#7c3aed",
  "Utility Bills": "#d97706", "Rent": "#0891b2",
  "Maintenance": "#f97316", "Stationery": "#64748b", "Miscellaneous": "#94a3b8",
};
const catColor = (cat) => CAT_COLORS[cat] || "#dc2626";

const statusColor = { paid: "#059669", pending: "#d97706", approved: "#0891b2", rejected: "#dc2626" };
...
const ExpenseManagement = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (v) => <span style={{ fontWeight: 700, fontSize: 14, color: "#dc2626" }}>{money(v)}</span>,
    },
    {
      title: "Date",
      dataIndex: "date",
  ...
  return (
    <div style={pageWrapper}>
      ...
      <div style={statGrid(150)}>
        {[
          { label: "Total Expenses", value: money(expenseTotalAmount), color: "#dc2626", icon: <FileTextOutlined /> },
          ...
          { label: "Pending",
            ...
            color: "#d97706", icon: <FileTextOutlined /> },
