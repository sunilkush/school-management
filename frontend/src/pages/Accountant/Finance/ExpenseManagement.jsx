  ...
  const columns = [
    {
      ...
      render: (_, r) => (
        <div>
          ...
          {r.paidTo && <div className="u-meta-xs">Paid to: {r.paidTo}</div>}
        </div>
      ),
    },
    {
    ...
    <div className="page-wrapper">
      ...
      <div className="section-panel">
        <Row gutter={[10, 10]} style={{ marginBottom: 14 }}>
          ...
          <Col xs={12} sm={3}>
            <Select value={statusFilter} onChange={setStatusFilter} placeholder="Status" className="u-full" allowClear>
