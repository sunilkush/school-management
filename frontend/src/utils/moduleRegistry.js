...
export const ROLE_MODULE_ACCESS = {
  ...
  "Vice Principal": ["academic-management", "student-management", "teacher-management", "attendance-system", "exam-result", "timetable-management", "learning-management", "reports-analytics", "communication"],
  Teacher: ["academic-management", "student-management", "attendance-system", "exam-result", "timetable-management", "learning-management", "communication", "reports-analytics"],
  "Subject Coordinator": ["academic-management", "teacher-management", "exam-result", "learning-management", "reports-analytics"],
  Student: ["learning-management", "exam-result", "timetable-management", "attendance-system", "library-management", "communication", "fees-management"],
