  ...
  async (_, { rejectWithValue }) => {
    try {
      const { data } = await httpClient.get(
        "/payroll-enterprise/reports/summary",
      );
      return data.data;
    } catch (e) {
  ...
  async (payload, { rejectWithValue }) => {
    try {
      const { data } = await httpClient.post(
        "/payroll-enterprise/run/generate",
        payload,
      );
      return data.data;
    } catch (e) {
...
export const approvePayrollRun = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const { data } = await httpClient.post(
        `/payroll-enterprise/run/${id}/approve`,
        {},
      );
      return data.data;
    } catch (e) {
...
export const createLoanRequest = createAsyncThunk(
  ...
  async (payload, { rejectWithValue }) => {
    try {
      const { data } = await httpClient.post(
        "/payroll-enterprise/loan/request",
        payload,
      );
      return data.data;
    } catch (e) {
