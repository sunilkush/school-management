...
export const sidebarMenu = {
  ...
  "super admin": [
    ...
    },
    {
      ...
      subMenu: [
        ...
        // Not "superadmin/support/modules" — this page is registered once at the top level and
        // shared by every role, unlike the four around it which are superadmin's own children.
        { title: "Modules & Roles", path: "support/modules" },
  ...
  "school admin": [
    ...
    },
    {
      ...
      subMenu: [
        ...
        { title: "Report Cards",  path: "schooladmin/exams/report-cards"  },
        { title: "Analytics",     path: "schooladmin/exams/analytics"     },
        { title: "Exam Reports",  path: "schooladmin/exams/reports"       },
      ],
    },
    { title: "Circulars", path: "schooladmin/circulars", icon: FileText },
    ...
    { title: "Surveys & Feedback", path: "schooladmin/surveys", icon: BarChart3 },
    {
      title: "HR",
      icon: BriefcaseIcon,
      subMenu: [
  ...
  teacher: [
    { title: "Overview", path: "teacher", icon: LayoutDashboard },
    {
      ...
      subMenu: [
        ...
        { title: "Circulars", path: "teacher/circulars" },
        { title: "Surveys", path: "teacher/surveys" },
  ...
  student: [
    ...
    { title: "Report Cards", path: "student/report-cards", icon: FileBadge },
    ...
    { title: "Circulars", path: "student/circulars", icon: FileText },
    { title: "Surveys", path: "student/surveys", icon: BarChart3 },
  ...
  parent: [
    ...
    { title: "Report Cards",     path: "parent/report-cards", icon: FileBadge },
    ...
    { title: "Circulars",         path: "parent/circulars",      icon: FileText },
    { title: "Surveys",           path: "parent/surveys",        icon: BarChart3 },
  ...
  principal: [
    ...
    { title: "Circulars", path: "principal/circulars", icon: FileText },
    { title: "Surveys & Feedback", path: "principal/surveys", icon: BarChart3 },
  ...
  "exam coordinator": [
    { title: "Overview", path: "examcoordinator", icon: LayoutDashboard },
    {
      ...
      subMenu: [
        ...
        { title: "Report Cards",  path: "examcoordinator/exams/report-cards"  },
