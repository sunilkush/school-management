...
export const sidebarMenu = {
  ...
  "school admin": [
    ...
    { title: "Task Management", path: "schooladmin/tasks", icon: ClipboardList },
  ...
  teacher: [
    ...
    { title: "My Tasks", path: "teacher/tasks", icon: ClipboardList },
  ...
  parent: [
    ...
    { title: "Leave Requests",    path: "parent/leave",        icon: ClipboardList },
    { title: "Transport",         path: "parent/transport",    icon: Bus },
    { title: "Hostel",            path: "parent/hostel",       icon: HelpCircle },
  ...
  accountant: [
    ...
    { title: "My Tasks",          path: "accountant/tasks",              icon: ClipboardList },
  ...
  principal: [
    ...
    { title: "My Tasks", path: "principal/tasks", icon: ClipboardList },
  ...
  "vice principal": [
    ...
    { title: "My Tasks", path: "viceprincipal/tasks", icon: ClipboardList },
  ...
  "exam coordinator": [
    ...
    { title: "My Tasks", path: "examcoordinator/tasks", icon: ClipboardList },
  ...
  "subject coordinator": [
    ...
    { title: "My Tasks", path: "subjectcoordinator/tasks", icon: ClipboardList },
    roleWorkspaceItem,
  ...
  librarian: [
    ...
    { title: "My Tasks", path: "librarian/tasks", icon: ClipboardList },
  ...
  "hostel warden": [
    ...
    { title: "My Tasks",          path: "hostelwarden/tasks",             icon: ClipboardList },
  ...
  receptionist: [
    ...
    { title: "My Tasks", path: "receptionist/tasks", icon: ClipboardList },
  ...
  "it support": [
    ...
    { title: "My Tasks", path: "itsupport/tasks", icon: ClipboardList },
  ...
  counselor: [
    ...
    { title: "My Tasks", path: "counselor/tasks", icon: ClipboardList },
  ...
  security: [
    ...
    { title: "My Tasks", path: "security/tasks", icon: ClipboardList },
